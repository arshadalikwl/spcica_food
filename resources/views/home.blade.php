                    ...
                    <div class="row">
                                ...
                                <div class="d-flex">
                                    <div>
                                        <img class="d-block rounded-circle" width="32"
                                            src="assets/dist/img/avatar-5.jpg">
                                    </div>
                                    <div class="pl-3">
                                        Nothing bad to say<br /> at this point 😌
                                        <a class="d-block mt-1 small opacity-75"
                                            href="mailto:hermanstarikov@gmail.com">Write back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="d-flex flex-column p-3 mb-3 bg-white shadow-sm rounded">
                                <div class="header-pretitle text-muted fs-11 font-weight-bold text-uppercase mb-2">avg time
                                    on site</div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <!--Top Referrals-->
                            <div class="d-flex flex-column p-3 mb-3 bg-white shadow-sm rounded">
                                <div class="header-pretitle text-muted fs-11 font-weight-bold text-uppercase mb-2">Top
                                    Referrals</div>
                                <div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <!--Sessions by device-->
                            <div class="d-flex flex-column p-3 mb-3 bg-white shadow-sm rounded">
                                <div class="header-pretitle text-muted fs-11 font-weight-bold text-uppercase mb-2">Sessions
                                    by device</div>
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        ...
                                                        <img src="assets/dist/img/avatar-2.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Miyah Myles">
                                                        <img src="assets/dist/img/avatar-3.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Daniela Dewitt">
                                                        <img src="assets/dist/img/avatar-4.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Daniela Dewitt">
                                                        <img src="assets/dist/img/avatar-5.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                </div>
                                            </td>
